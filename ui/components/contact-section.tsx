      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          >
            ...
            <div className="relative mt-8 aspect-video overflow-hidden rounded-xl border border-border bg-card/50 shadow-sm transition-colors hover:border-forest/30">
              <ContactMapLeaflet />
            </div>
          </div>
        </div>
