  ...
  return (
    <div>
      ...
      <div className="h-2 w-full rounded-full bg-border overflow-hidden">
        <div className="h-full bg-forest rounded-full" style={{ width: `${percentage}%` }} />
      </div>
    </div>
  )
}
...
function CsvImportSection({ onImportSuccess }: { onImportSuccess: () => void }) {
  return (
    <div className="rounded-3xl border border-border bg-card p-8 text-center">
      <p className="text-muted-foreground">Sección de importación CSV disponible.</p>
    </div>
  )
}