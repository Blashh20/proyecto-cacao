...
const products = [
  {
    id: 1,
    name: "Cafe de Origen Tostado",
    description: "Cafe seleccionado con perfil aromatico limpio para preparaciones filtradas y espresso.",
    price: "$18.000",
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Cacao colombiano de alta calidad para bebidas, reposteria y formulaciones gourmet.",
    price: "$24.000",
    rating: 4.8,
  ...
  },
  {
    id: 3,
    name: "Nibs de Cacao",
    description: "Fragmentos crujientes de cacao tostado para snacks, mezclas funcionales y gastronomia.",
    price: "$16.000",
    rating: 4.7,
  ...
  {
    id: 4,
    name: "Linea Institucional Makakaw",
    description: "Soluciones para negocios, marcas y compradores interesados en cafe y cacao de origen.",
    price: "$32.000",
    rating: 4.9,
...
export function ProductsSection() {
  ...
  return (
    <section id="productos" ref={sectionRef} className="relative overflow-hidden py-20 md:py-32">
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        <div className="mb-14 flex flex-col gap-6 md:mb-16 md:flex-row md:items-end md:justify-between">
          ...
          >
            <span className="text-sm uppercase tracking-wider">Solicitar catalogo</span>
              ...
              <div className="overflow-hidden rounded-2xl border border-border bg-card transition-all duration-500 hover:border-forest/50">
                <div className="relative aspect-square overflow-hidden">
                  ...
                  <button
                    className={cn(
                      ...
                      hoveredProduct === product.id ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0 sm:opacity-0",
                ...
                <div className="p-5 sm:p-6">
                  <div className="mb-2 flex items-center gap-1">
                    ...
                    <span className="text-sm text-cream/70">{product.rating}</span>
                  </div>

                  <h3 className="mb-2 text-lg font-semibold text-cream transition-colors group-hover:text-forest-light">
                    {product.name}
                  </h3>
                  <p className="mb-4 text-sm leading-relaxed text-cream/50 line-clamp-2">{product.description}</p>

                  <div className="flex items-center justify-between gap-3">
                    <span className="text-xl font-bold text-forest-light">{product.price}</span>
                    <span className="text-xs uppercase tracking-wider text-cream/40">COP</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <p className="mx-auto mb-6 max-w-xl text-cream/60">
            Makakaw integra cafe y cacao en un portafolio con enfoque en calidad, trazabilidad y relaciones comerciales de largo plazo.
          </p>
          <a
            href="#contacto"
          ...
          >
            <ShoppingBag size={20} />
            <span className="text-sm uppercase tracking-wider">Hablar con ventas</span>
          </a>
        </div>
      </div>
    </section>
